...
import useRandomMovie from "../hooks/useRandomMovie.js";
...
export const Billboard = () => {
  ...
  return (
    <div className="relative h-[56vh]">
      <video
        className="w-full h-[56vh] object-cover brightness-[60%] transition duration-500"
        autoPlay
        muted
        poster={randomMovie?.thumbnailUrl}
        src={randomMovie?.videoUrl}></video>
